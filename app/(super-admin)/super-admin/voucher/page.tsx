...
export default function AdminVoucherManager() {
  ...
  // Logic Xóa có kiểm tra ràng buộc
  const handleDelete = async () => {
    if (!selectedVoucher) return;
    
    // Check FE một lần nữa cho chắc
    ...
    try {
      ...
      if (res.ok) {
        ...
        // Thông báo từ server nếu không xóa được (ví dụ: lỗi Foreign Key)
