...
interface MovieCardProps {
  ...
  title: string;
  image: string;
  rating?: number | string | null; // ⭐ điểm đánh giá trung bình
  reviewCount?: number;            // 👥 tổng lượt đánh giá
  ageRating?: string;
  status?: string;
}
...
export default function MovieCard({
  ...
  const handleImageError = (
    ...
    e.currentTarget.src =
      "https://png.pngtree.com/png-clipart/20190611/original/pngtree-surprised-face-expression-png-image_2888052.jpg";
  };
        ...
        <div>
          ...
          <div className="flex items-center gap-2 mb-3 min-h-[24px]">
            ...
            {hasRating ? (
              ...
              <span className="text-zinc-500 text-[14px] font-medium">
                Chưa có đánh giá
              </span>
            )}
          </div>
          ...
          <h3 className="
            ...
            tracking-tighter
            leading-tight mb-3 cursor-pointer
          ">
            {title}
          </h3>
