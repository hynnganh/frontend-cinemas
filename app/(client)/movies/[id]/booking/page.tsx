    ...
    async () => {
      ...
      try {
        ...
        const futureShowtimes =
          fetchedShowtimes.filter(
            (st: any) => {
              try {
                // BACKEND:
                // startTime = 2026-05-29T18:30:00
        ...
        if (
          parentCinemas.length > 0
        ) {
          setSelectedParent(
            (prev) =>
              prev &&
              parentCinemas.includes(
                prev
              )
                ? prev
                : parentCinemas[0]
        ...
        {loading ? (
          ...
          Object.entries(
            ...
            ([
              ...
              <div
                key={branchName}
                className="bg-zinc-900/20 border border-zinc-800/50 rounded-xl p-4"
              >
                ...
                <div className="flex items-center gap-2 mb-4 border-b border-zinc-800 pb-3">
                  ...
                  <h4 className="text-[12px] font-black tracking-wide text-zinc-100">
                    {branchName}
                  </h4>
                </div>
